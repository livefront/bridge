...
public class Bridge {
   ...
   * {@link android.os.TransactionTooLargeException}. The actual state saving and restoration of
   * each object will be performed by the provided {@link SavedStateHandler}. Note that in order to
  ...
  /**
   * Restores the state of the given target object based on tracking information stored in the given
   * {@link Bundle}. The actual saved data will be retrieved from a location in memory or stored on
   * disk.
   *
   * <p>It is required to call {@link #initialize(Context, SavedStateHandler)} before calling this
   * method.
  ...
  /**
   * Restores the state of the given {@link View} based on tracking information stored in the given
   * {@link Parcelable} object. The actual saved data will be retrieved from a location in memory or
   * stored on disk.
   *
   * <p>It is required to call {@link #initialize(Context, SavedStateHandler,
  ...
  /**
   * Saves the state of the given target object to a location in memory and disk and stores tracking
   * information in given {@link Bundle}.
   *
   * <p>It is required to call {@link #initialize(Context, SavedStateHandler)} before calling this
   * method.
   */
  ...
  /**
   * Saves the state of the given {@link View} to a location in memory and disk and stores tracking
   * information in the returned {@link Parcelable} object.
   *
   * <p>It is required to call {@link #initialize(Context, SavedStateHandler)} before calling this
   * method.
   *
